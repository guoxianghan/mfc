...
namespace SNTON.Components.ComLogic
{
    ...
    public class MidStoreRobotArmLogic : ComLogic
    {
        ...
        void ReadWarningInfo()
        {
            ...
            int ii = IsAuto();//龙门状态，0自动无故障，1退出自动无故障，2故障
            ...
            foreach (var item in _WarnningCode.GroupBy(x => x.AddressName.Trim()))
            {
                ...
                for (int c = 0; c < binary.Length; c++)
                {
                    ...
                    if (fi == null)
                        continue;
                    if (fi == null || (fi.PLCAddress.Trim() == "D651" && fi.BIT == 8))
                        continue;
                    ...
                    if (binary[c] == '1')
                    {
                        ...
                        if (!fi.LastWarning)
                            this.BusinessLogic.MessageInfoProvider.Add(null, new MessageEntity() { Created = DateTime.Now, MsgContent = this.StorageArea + "号龙门" + fi.Description.Trim(), Source = this.StorageArea + "号龙门报警", MsgLevel = 7, MidStoreage = this.StorageArea });
                    }
                    else
                        fi.IsWarning = false;
                }
        ...
        public override void ReadDervice()
        {
            ...
            if (storageseqno == armtsk.FromWhere) //&& receivearmcomm == sendarmcmd
            {
                ...
                if (r)
                {
                    ...
                    {
                        this.BusinessLogic.EquipTaskProvider.UpdateStatus(4, null, (from fi in equiptsks select fi.Id).ToArray());
                    }
                    if (i == 2)
                    {
    ...
    class MidStoreRobotArmNeu
    {
        /// <summary>
        /// 标志位：D800可读可写。PLC给D800写1，表示允许上位机向指令区写指令。上位机给D800写2，表示允许PLC读取指令区指令。
        /// </summary>
        public int req_FLAGBIT { get; set; }
        /// <summary>
        /// 指令码：1入库，2出库，3异常口处理，4异常口出库
        /// </summary>
        public int req_COMMAND { get; set; }
        /// <summary>
        /// 库位号
        /// </summary>
        public int req_STORE_NO { get; set; }
        /// <summary>
        /// 出库位置号
        /// </summary>
        public int req_OUT_STORE_LOCATION { get; set; }
        /// <summary>
        /// 工字轮直径;单位:0.1mm
        /// </summary>
        public int req_WHEEL_L { get; set; }
        /// <summary>
        /// 所取工字轮高度;单位:0.1mm
        /// </summary>
        public int req_WHEEL_GET_HIGH { get; set; }
        /// <summary>
        /// 所放工字轮高度;单位:0.1mm
        /// </summary>
        public int req_WHEEL_SET_HIGH { get; set; }
        /// <summary>
        /// 物料种类
        /// </summary>
        public int req_MaterialType { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int req_BACKUP1 { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int req_BACKUP2 { get; set; }
        public int res_COMMAND_AUTO { get; set; }
        /// <summary>
        /// 库位号(自动反馈)
        /// </summary>
        public int res_STORE_NO_AUTO { get; set; }
        /// <summary>
        /// 出库位置号(自动反馈)
        /// </summary>
        public int res_OUT_STORE_LOCATION_AUTO { get; set; }
        /// <summary>
        /// 工字轮直径(自动反馈)
        /// </summary>
        public int res_WHEEL_L_AUTO { get; set; }
        /// <summary>
        /// 取料高度(自动反馈)
        /// </summary>
        public int res_WHEEL_GET_HIGH_AUTO { get; set; }
        /// <summary>
        /// 放料高度(自动反馈)
        /// </summary>
        public int res_WHEEL_SET_HIGH_AUTO { get; set; }
        /// <summary>
        /// 物料种类：1-6（对应6种工字轮轮型）（自动反馈）
        /// </summary>
        public int res_MaterialType_AUTO { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int res_BACKUP1_AUTO { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int res_BACKUP2_AUTO { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int res_BACKUP3_AUTO { get; set; }
        /// <summary>
        /// 指令码，1入库，2出库，3异常口处理，4异常口出库(手动反馈)
        /// </summary>
        public int res_COMMAND_UNAUTO { get; set; }
        /// <summary>
        /// 库位号(手动反馈)
        /// </summary>
        public int res_STORE_NO_UNAUTO { get; set; }
        /// <summary>
        /// 出库位置号(手动反馈)
        /// </summary>
        public int res_OUT_STORE_LOCATION_UNAUTO { get; set; }
        /// <summary>
        /// 工字轮直径(手动反馈)
        /// </summary>
        public int res_WHEEL_L_UNAUTO { get; set; }
        /// <summary>
        /// 取料高度(手动反馈)
        /// </summary>
        public int res_WHEEL_GET_HIGH_UNAUTO { get; set; }
        /// <summary>
        /// 放料高度(手动反馈)
        /// </summary>
        public int res_WHEEL_SET_HIGH_UNAUTO { get; set; }
        /// <summary>
        /// 物料种类：1-6（对应6种工字轮轮型）（手动反馈）
        /// </summary>
        public int res_MaterialType_UNAUTO { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int res_BACKUP1_UNAUTO { get; set; }
        /// <summary>
        /// 备用
        /// </summary>
        public int res_BACKUP2_UNAUTO { get; set; }
        /// <summary>
        /// 龙门状态，0自动无故障，1退出自动无故障，2故障
        /// </summary>
        public int res_LONGMEN_STATE { get; set; }
        /// <summary>
        /// 报警信息
        /// </summary>
        public int res_Warning0 { get; set; }
        /// <summary>
        /// 报警信息
        /// </summary>
        public int res_Warning1 { get; set; }
        /// <summary>
        /// 报警信息
        /// </summary>
        public int res_Warning2 { get; set; }
